...
const TIERS = [
  ...
  },
  {
    ...
    features: [
      ...
      ["Rapports avancés + export CSV", true],
  ...
  },
  {
    ...
    amount: "90 000 F",
    period: "/an",
    sub: "2 caisses incluses · ou 10 000 F/mois",
    features: [
      ["Tout Commerce / Supermarché", true],
      ["Plusieurs caisses reliées", true],
      ["Stock, clients & crédits partagés", true],
      ["Chiffre par caisse et par vendeur", true],
      ["Rôles patron / vendeur", true],
    ],
    plan: "grand_boutique",
    cta: "Payer en ligne",
    note: "Carte ou mobile money · ou paie au mois sur WhatsApp",
